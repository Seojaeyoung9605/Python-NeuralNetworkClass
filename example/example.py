...
nw = NeuralNetwork(template=[1, 4, 9, 10, 1], syn_prc=90, co=0.7, nmin=0, nmax=3000)
...
#-rep. Repetitions. The number of times, that the network is going to educate on the given file.   More repetition - better result.  Default - 1
#
...
#Now you can print it and see, what's inside.
nw.print()
...
#P.S. 
#There are also some already educated networks in this folder. Try them, if you want.
